...
const LandingPage = () => {
    return (
        <section className="h-[100vh] bg-stars relative to-red-50">
            ...
            <div className="absolute top-20  right-0 lg:right-40 w-[120px] sm:w-[200px] lg:w-[250px]">
                {" "}
                <Image src={Santa} alt="icons" />
            </div>
            <div className="absolute bottom-20 left-0 lg:left-40 w-[120px] sm:w-[200px] lg:w-[250px]">
                {" "}
                <Image src={Basket} alt="icons" />
            </div>
            <div className="absolute bottom-32 right-0 lg:right-32 xl:right-52 w-[50px] sm:w-[130px] lg:w-[200px]">
                {" "}
                <Image src={Tree} alt="icons" />
            </div>
            <div className="flex items-center justify-center mx-auto absolute bottom-0 left-0 right-0 w-[100px] sm:w-[150px] lg:w-[170px]">
                {" "}
                <Image src={Gift} alt="icons" />
            </div>

            <div className="flex flex-col justify-center items-center mt-52 absolute left-0 right-0">
